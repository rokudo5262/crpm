    ...
    if (get_option('cron_has_run_from_cli') == 0) {
        if (is_admin()) {
            ...
            if ($using_cron_features > 0 && get_option('hide_cron_is_required_message') == 0) {
                ...
                echo '<br />Please follow the cron <a href="https://demo.flamestech.com/crpm/help/setup-cron-job/" target="_blank">setup guide</a> in order all features to work well.';
                echo '<br /><br /><br />';
