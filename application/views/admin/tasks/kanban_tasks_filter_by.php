...
<div class="btn-group pull-left mleft10 mbot25 btn-with-tooltip-group _filter_data" data-toggle="tooltip" data-title="<?php echo _l('filter_by'); ?>">
   ...
   <ul class="dropdown-menu width300">
    ...
    <li class="clear-all-prevent task-statuses-filter task-statuses-filter-<?php echo $status['id']; ?> task_status_<?php echo $status['id']; ?> active" data-id="<?php echo $status['id']; ?>">
        <a href="#" data-cview="task_status_<?php echo $status['id']; ?>" onclick="kb_status_visibility(<?php echo $status['id']; ?>)">
        ...
        <li class="dropdown-submenu department-filter pull-left">
            ...
            <ul class="dropdown-menu dropdown-menu-left">
                ...
                <li class="department_<?php echo $department['departmentid']; ?>">
                    <a href="#" data-cview="department_<?php echo $department['departmentid']; ?>" onclick="kb_custom_view(<?php echo $department['departmentid']; ?>,'department_<?php echo $department['departmentid']; ?>'); return false;"><?php echo $department['name']; ?></a>
                </li>
                <?php } ?>
            </ul>
        </li>
       ...
       <a href="#" tabindex="-1"><?php echo _l('filter_by_assigned'); ?></a>
           <ul class="dropdown-menu dropdown-menu-left">
            ...
            <li class="task_assigned_<?php echo $as['assigneeid']; ?>">
                <a href="#" data-cview="task_assigned_<?php echo $as['assigneeid']; ?>" onclick="kb_custom_view(<?php echo $as['assigneeid']; ?>,'task_assigned_<?php echo $as['assigneeid']; ?>'); return false;"><?php echo $as['full_name']; ?></a>
            </li>
            <?php } ?>
        </ul>
    </li>
