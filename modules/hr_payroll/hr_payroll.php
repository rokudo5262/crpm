...
define('HR_PAYROLL_REVISION', 1000);
...
function hr_payroll_module_init_menu_items()
{
    ...
    if(has_permission('hrp_employee','','view') || has_permission('hrp_attendance','','view') || has_permission('hrp_commission','','view') || has_permission('hrp_deduction','','view') || has_permission('hrp_bonus_kpi','','view') || has_permission('hrp_insurrance','','view') || has_permission('hrp_payslip','','view') || has_permission('hrp_payslip_template','','view') || has_permission('hrp_income_tax','','view') || has_permission('hrp_report','','view') || has_permission('hrp_setting','','view') ){
    ...
    if(has_permission('hrp_employee','','view')){
    ...
    if(has_permission('hrp_attendance','','view')){
        $CI->app_menu->add_sidebar_children_item('hr_payroll', [
    ...
    if(has_permission('hrp_commission','','view')){
        $CI->app_menu->add_sidebar_children_item('hr_payroll', [
    ...
    if(has_permission('hrp_deduction','','view')){
        $CI->app_menu->add_sidebar_children_item('hr_payroll', [
    ...
    if(has_permission('hrp_bonus_kpi','','view')){
        $CI->app_menu->add_sidebar_children_item('hr_payroll', [
            'slug'     => 'hr_bonus_kpi',
    ...
    if(has_permission('hrp_insurrance','','view')){
        $CI->app_menu->add_sidebar_children_item('hr_payroll', [
            'slug'     => 'hrp_insurrance',
    ...
    if(has_permission('hrp_payslip','','view')){
        $CI->app_menu->add_sidebar_children_item('hr_payroll', [
            'slug'     => 'hr_pay_slips',
    ...
    if(has_permission('hrp_payslip_template','','view')){
        $CI->app_menu->add_sidebar_children_item('hr_payroll', [
    ...
    if(has_permission('hrp_income_tax','','view')){
        $CI->app_menu->add_sidebar_children_item('hr_payroll', [
            'slug'     => 'hrp_income_tax',
...
function hr_payroll_load_js(){
 ...
 if (!(strpos($viewuri,'admin/hr_payroll/view_payslip_templates_detail') === false)){
    echo '<script src="'.module_dir_url(HR_PAYROLL_MODULE_NAME, 'assets/plugins/luckysheet/js/luckysheet.umd.js').'?v=' . HR_PAYROLL_REVISION.'"></script>';
...
function hr_payroll_permissions()
{
    ...
    register_staff_capabilities('hrp_attendance', $capabilities, _l('hr_payroll_attendance'));
    register_staff_capabilities('hrp_commission', $capabilities, _l('hr_payroll_commission'));
    register_staff_capabilities('hrp_deduction', $capabilities, _l('hr_payroll_deduction'));
    register_staff_capabilities('hrp_bonus_kpi', $capabilities, _l('hr_payroll_bonus_kpi'));
    register_staff_capabilities('hrp_insurrance', $capabilities, _l('hr_payroll_insurrance'));
    register_staff_capabilities('hrp_payslip', $capabilities, _l('hr_payroll_payslip'));
    register_staff_capabilities('hrp_payslip_template', $capabilities, _l('hr_payroll_payslip_template'));
    register_staff_capabilities('hrp_income_tax', $capabilities, _l('hr_payroll_income_tax'));
