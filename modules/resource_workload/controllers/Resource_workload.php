...
class Resource_workload extends AdminController {
	...
	public function index() {
        ...
        if ($data['type'] == 'workload') {
			...
			$data['data_workload'] = $this->resource_workload_model->get_data_workload($data_fill);
			$data['estimate_stats'] = json_encode($this->resource_workload_model->estimate_stats($data['data_workload'], $standard_workload));
			$department_stats = $this->resource_workload_model->department_stats($data['data_workload'], $standard_workload);
			$data['department_stats'] = json_encode($department_stats['department_stats']);
			$data['spent_stats'] = json_encode($this->resource_workload_model->spent_stats($data['data_workload'], $standard_workload));
    ...
    public function workload_chart(){
    	...
    	$estimate_stats = $this->resource_workload_model->estimate_stats($data_workload, $standard_workload);
		$d_stats = $this->resource_workload_model->department_stats($data_workload, $standard_workload);
		$department_stats = $d_stats['department_stats'];
		$column_department = $d_stats['column_department'];
		$spent_stats = $this->resource_workload_model->spent_stats($data_workload, $standard_workload);
