         ...
         <div class="col-md-5 left-column">
            <div class="panel_s">
               <div class="panel-body">
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        <?php echo render_input('zoom_registrant_meetid','zoom_registrant_meetid','','text',array('required'=>'true')); ?>
                     </div>   
                  </div>
                  <div class="row">
                     <div class="col-md-6">
                     ...
                     <div class="col-md-6">
                        <?php echo render_input('zoom_registrant_lname','zoom_registrant_lname','','text',array('required'=>'true')); ?>
                     </div>
                  </div>
