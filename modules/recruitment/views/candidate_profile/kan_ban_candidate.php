...
foreach ($statuses as $status) { 
  ...
  ?>
  <ul class="kan-ban-col candicate-kanban" data-col-status-id="<?php echo html_entity_decode($status['id']); ?>" data-total-pages="<?php echo html_entity_decode($total_pages); ?>">
      ...
      <div class="border-right panel_s">
        ...
        <div class="kan-ban-content-wrapper kan-ban-wrapper-min-height">
          <div class="kan-ban-content">
            <ul class="status tasks-status sortable relative" data-candidate-status-id="<?php echo html_entity_decode($status['id']); ?>">
              <?php
              ...
              foreach ($candidates as $candidate) {
                if ($candidate['status'] == $status['id']) {
                  $this->load->view('recruitment/candidate_profile/_kan_ban_card_candidate',array('candidate'=>$candidate,'status'=>$status['id']));
                } } ?>
